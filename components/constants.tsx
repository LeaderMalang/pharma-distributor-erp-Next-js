...
export const ICONS = {
  ...
  pos: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 6H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2Z"/><path d="M12 18V8"/><path d="M8 18V8"/><path d="M16 18V8"/><path d="M6 12h12"/></svg>,
  expense: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg>,
  ...
  orders: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg>,
  ecommerce: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>,
  qr_code: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><path d="M3 14h7v7H3z"/></svg>,
  recovery: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>,
  leave: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 17a5 5 0 0 1-5-5v-2a5 5 0 0 1 5-5h11v12H8z"/><path d="M15 17v-2a3 3 0 0 0-3-3H6"/></svg>,
  ledger: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>,
  stock_audit: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/><path d="m9 14 2 2 4-4"/></svg>,
  investor: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
};
...
// Ecommerce Mock Data
export const ECOMMERCE_ORDERS: EcommerceOrder[] = [
    {
        id: 'ecom-1',
        orderNo: 'ECOM-2024-001',
        date: '2024-07-30',
        customerId: 101, // City Pharmacy
        customer: PARTIES_DATA.find(p => p.id === 101) || null,
        salesmanId: 2, // Jane Smith
        status: 'Pending',
        totalAmount: 525.00,
        paidAmount: 525.00,
        address: '101 Med Lane, Metropolis',
        items: [
            { id: 'eitem-1-1', productId: 101, quantity: 50, rate: 10.50, amount: 525.00 }
        ]
    },
    {
        id: 'ecom-2',
        orderNo: 'ECOM-2024-002',
        date: '2024-07-29',
        customerId: 102, // Wellness Drug Store
        customer: PARTIES_DATA.find(p => p.id === 102) || null,
        salesmanId: 2,
        status: 'Confirmed',
        totalAmount: 1125.00,
        paidAmount: 0,
        saleInvoiceId: '1', // Linked to INV-2024-001
        address: '202 Health Blvd, Metropolis',
        items: [
             { id: 'eitem-2-1', productId: 201, quantity: 25, rate: 45.00, amount: 1125.00 }
        ]
    },
    {
        id: 'ecom-3',
        orderNo: 'ECOM-2024-003',
        date: '2024-07-28',
        customerId: 103, // Rajana Medical
        customer: PARTIES_DATA.find(p => p.id === 103) || null,
        status: 'Completed',
        totalAmount: 787.50,
        paidAmount: 787.50,
        saleInvoiceId: '2',
        address: 'Main Bazaar, Rajana',
        items: [
             { id: 'eitem-3-1', productId: 103, quantity: 50, rate: 15.75, amount: 787.50 }
        ]
    },
    {
        id: 'ecom-4',
        orderNo: 'ECOM-2024-004',
        date: '2024-07-27',
        customerId: 101,
        customer: PARTIES_DATA.find(p => p.id === 101) || null,
        status: 'Cancelled',
        ...
        address: '101 Med Lane, Metropolis',
        items: [
             { id: 'eitem-4-1', productId: 102, quantity: 10, rate: 25.00, amount: 250.00 }
        ]
    }
];